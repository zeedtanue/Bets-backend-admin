...
export interface ApiJobOpportunityJobOpportunity extends Schema.CollectionType {
  ...
  attributes: {
    ...
    company: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'BETS BD'>;
    location: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'Dhaka, Bangladesh'>;
    type: Attribute.Enumeration<['On-Site', 'Remote', 'Hybrid']>;
    shortDescription: Attribute.Text;
    responsibilities: Attribute.RichText;
    requirements: Attribute.RichText;
    conclusions: Attribute.Text;
    positionType: Attribute.Enumeration<['Full-Time', 'Part-Time']>;
...
export interface ApiLatestUpdateLatestUpdate extends Schema.CollectionType {
  collectionName: 'latest_updates';
  info: {
    singularName: 'latest-update';
    pluralName: 'latest-updates';
  ...
  attributes: {
    bulletin: Attribute.Text;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::latest-update.latest-update',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiNewsAndUpdateNewsAndUpdate extends Schema.CollectionType {
  ...
  attributes: {
    ...
    news_category: Attribute.Relation<
      'api::news-and-update.news-and-update',
      'manyToOne',
      'api::news-category.news-category'
    >;
    slug: Attribute.UID<'api::news-and-update.news-and-update', 'Title'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiNewsCategoryNewsCategory extends Schema.CollectionType {
  ...
  attributes: {
    Name: Attribute.String;
    news_and_updates: Attribute.Relation<
      'api::news-category.news-category',
      'oneToMany',
      'api::news-and-update.news-and-update'
    >;
...
export interface ApiProjectsListProjectsList extends Schema.CollectionType {
  ...
  attributes: {
    ...
    service_sector: Attribute.Relation<
      'api::projects-list.projects-list',
      'manyToOne',
      'api::service-sector.service-sector'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiServiceSectorServiceSector extends Schema.CollectionType {
  collectionName: 'service_sectors';
  info: {
    singularName: 'service-sector';
    pluralName: 'service-sectors';
    displayName: 'ServiceSector';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    projects_lists: Attribute.Relation<
      'api::service-sector.service-sector',
      'oneToMany',
      'api::projects-list.projects-list'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::latest-update.latest-update': ApiLatestUpdateLatestUpdate;
      ...
      'api::service-sector.service-sector': ApiServiceSectorServiceSector;
    }
  }
}
