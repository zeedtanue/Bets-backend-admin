...
export interface ApiContactUsQueryContactUsQuery extends Schema.CollectionType {
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::contact-us-query.contact-us-query',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiFeatureProjectFeatureProject extends Schema.CollectionType {
  ...
  info: {
    singularName: 'feature-project';
    pluralName: 'feature-projects';
    displayName: 'Feature Projects ';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    dateOfCompletion: Attribute.Date;
    shortDescription: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::feature-project.feature-project',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    years_in_business: Attribute.Integer;
...
export interface ApiProjectsListProjectsList extends Schema.CollectionType {
  ...
  attributes: {
    ...
    details_pdf: Attribute.Media;
    our_service: Attribute.Relation<
      'api::projects-list.projects-list',
      'manyToOne',
      'api::our-service.our-service'
    >;
...
export interface ApiUsefulLinkUsefulLink extends Schema.CollectionType {
  ...
  attributes: {
    displayText: Attribute.String & Attribute.Required;
